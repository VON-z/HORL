...
class TRPO:
    def __init__(self, hidden_dim, state_space, action_space,
                lmbda, kl_constraint, alpha, critic_lr, gamma, device) -> None:
    ...
    def hessian_matrix_vector_product(self, states, old_action_dists, vector):
        ...
        kl = torch.mean(
            torch.distributions.kl_divergence(old_action_dists, 
                                              new_action_dists))
    ...
    def update(self, transition_dict):
        ...
        advantage = compute_advantage(self.gamma, self.lmdba, td_delta.cpu()).to(self.device)
